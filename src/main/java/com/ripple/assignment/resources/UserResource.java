...
import com.ripple.assignment.Constants;
import com.ripple.assignment.domain.User;
import com.ripple.assignment.services.UserService;
...
public class UserResource {
    ...
    public ResponseEntity<Map<String, String>> registerUser(@RequestBody Map<String, Object> userMap) {
        ...
        User user = userService.registerUser(firstName, lastName, email, password,mobile,role);
        return new ResponseEntity<>(generateJWTToken(user), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Map<String, Boolean>> deleteUser(HttpServletRequest request,
        ...
        userService.removeUserWithAllVMs(userId);
